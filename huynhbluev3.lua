...
if not isfolder("HuynhBlue") then
makefolder("HuynhBlue")
end
if not isfolder("HuynhBlue/Blox Fruits/") then
makefolder("HuynhBlue/Blox Fruits/")
end
if not isfile("HuynhBlue/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
writefile("HuynhBlue/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
else
  local Decode = game:GetService("HttpService"):JSONDecode(readfile("HuynhBlue/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
writefile("HuynhBlue/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
end
else
  return warn("Status : Undetected Executor")
end
